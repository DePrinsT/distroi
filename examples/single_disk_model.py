...
oi_observables.plot_data_vs_model(container_data, container_model, fig_dir=f"{fig_dir}/monochromatic", show_plots=True)
...
oi_observables.plot_data_vs_model(container_data, container_model, fig_dir=f"{fig_dir}/chromatic", show_plots=True)
