...
These spectral dependencies can be attached to single model images (ImageFFT objects) or geometric components in the
calculation of interferometric observables. Support is provided for spectral dependencies in F_lam, lam x F_lam, F_nu
and nu x F_nu flux formats.
"""
...
# TODO: make this spectral dependence work when attached to an ImageFFT. This seems to cause an overflow at the moment.
